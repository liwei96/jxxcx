<template>
	<view class="sign">
		...
		<view class="one" v-if="!iscode">
			...
			<view class="msg">
				<jiuaicheckbox @change='changeBox' borderStyle='1px solid #D4D7D9' color='#40A2F4' :checked='checked'
					:borderRadius='6' :fontSize='20' :checkBoxSize='30'></jiuaicheckbox>我已阅读并同意<text>《允家服务协议》</text>
			</view>
